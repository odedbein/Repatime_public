...
behav_varname={'first_rawRT','first_RT_difFromRep1_posXrep1_minus_posXrepX','first_RT_difFromPos1Rep1_posXRep1MinRepX_min_pos1Rep1MinRepX','first_response_pleasantness',...
    'second_rawRT','second_RT_difFromRep1_posXrep1_minus_posXrepX','second_RT_difFromPos1Rep1_posXRep1MinRepX_min_pos1Rep1MinRepX','second_response_pleasantness',...
...
parts={'first','second'};
pp={'rawRT','diff_rep1','diff_rep1pos1','response_pleasantness'};
behave_data_table=[];
for p=1:numel(parts)
    for t=1:numel(pp)
...
T.Properties.VariableNames=header;
%write it up:
results_fname=['model_and_TemporalTest_' add_behav_fname '.txt'];
filename=fullfile(Rfiles_behavior_dir,results_fname);
writetable(T,filename,'Delimiter','\t')
