...
#all of them:
	...
	declare -a subjects=(2ZD 3RS 5BS 6GC)
elif (( $group == 2 )); then
	declare -a subjects=(8PL 9IL 10BL)
elif (( $group == 3 )); then
	declare -a subjects=(13GT 14MR 16DB)
elif (( $group == 4 )); then
	declare -a subjects=(19AB 20SA 21MY)
elif (( $group == 5 )); then
	declare -a subjects=(25AL 26MM 28HM) 
elif (( $group == 6 )); then
	declare -a subjects=(7MS 34RB 36AN)
elif (( $group == 7 )); then
	declare -a subjects=(11CB 12AN 24DL)
elif (( $group == 8 )); then
	declare -a subjects=(17VW 18RA 30RK)
fi
...
echo "analyzing step 1 subject $subj"
...
for list in {1..6}; do
	for rep in {1..5}; do
		echo "reorienting and fm correcting encoding subj $subj list $list rep $rep"
...
for list in {1..6}; do
echo "reorienting and fm correcting similarity pre and post subj $subj list $list"
...
for list in {1..6}; do
	echo "reorienting and fm correcting order test subj $subj list $list"
...
# color memory test
for run in {1..4}; do
	echo "reorienting and fm correcting color test subj $subj run $run"
