...
subj=22JP
#on day 2, fm correction to the second fm didn't work, I correct it to the first one.
...
#### ANATOMY ####################################################
#03/19: didn't run it again - just copy from old files
...
#in running fsl 5.0.011 I don't want to run bet again. so cancel it out.
